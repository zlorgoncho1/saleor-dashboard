...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "5ae60fc5-e5f1-4625-9106-d157db596d81", e._sentryDebugIdIdentifier = "sentry-dbid-5ae60fc5-e5f1-4625-9106-d157db596d81");
  } catch (e2) {
  }
}();
const PRXpBm = {
...
const k0rGBI = {
  string: "\xC5tkomsttoken anv\xE4nds f\xF6r att autentisera servicekonton"
};
const t9a9GQ = {
...
const Fxa6xp = {
  context: "page header",
  string: "L\xE4gg till kollektion"
};
const G4g5Ii = {
  context: "tab name",
...
const U2mOqA = {
  string: "Ingen rabattkupong hittad"
};
const GVinbz = {
  context: "column title",
  string: "V\xE4rde"
...
const GLX9II = {
  ...
  string: "Samma som leveransadress"
};
const Qovenh = {
...
const bS7A8u = {
  ...
  string: "L\xE4gg till sp\xE5rning"
};
const dTkmON = {
  context: "edit tracking button",
  string: "\xC4ndra sp\xE5rning"
};
const EHsnZX = {
  context: "dialog description",
...
const uUsZ7m = {
  context: "order payment",
  string: "Summa f\xF6r automatisk betalning"
};
const HaQ8cg = {
  context: "button",
  string: "\xC5terbetalning"
};
const uzAPCt = {
...
const XMrYaA = {
  context: "checkbox label",
  string: "Anv\xE4ndaren \xE4r aktiv"
};
const YJ4TXc = {
  context: "tab name",
...
const FNKhkx = {
  string: "L\xE4gg p\xE5 moms f\xF6r fraktkostnad"
};
const HtQGEH = {
...
const Xb6BJ9 = {
  context: "error message",
  string: "Manuella betalningar kan inte \xE5terbetalas"
};
const WzA5Ll = {
...
const sZ27WU = {
  context: "error message",
  string: "Endast automatbetalningar kan avbrytas"
};
const gKdGxP = {
  context: "error message",
  string: "Endast automatbetalningar kan anv\xE4ndas"
};
const V2BBQu = {
...
const VEE4gD = {
  context: "error message",
  string: "Leveransmetod \xE4r ej giltig f\xF6r vald leveransadress"
};
const ychKsb = {
  context: "error message",
...
const sv = {
  ...
  "3tbL7x": {
    context: "description",
    string: "Gl\xF6mt ditt l\xF6senord?"
  },
  ENBELI,
  M4q0Ye,
  tTtoKd,
  ...
  ChAjJu,
  "s/sTT6": {
    string: "Om det \xE4r tomt visar f\xF6rhandsvisningen vad som kommer att vara autogenererat."
  },
  "450Fty": {
    string: "None"
  },
  ...
  "/oyr6M": {
    context: "no variants",
    string: "Inga varianter hittades"
  },
  Q1HhPk,
  lHccsy,
  "2E1xZ0": {
  ...
  G3ay2p,
  "yT/GAp": {
    string: "Sp\xE5rningsnummer"
  },
  "/BJQIq": {
    context: "dialog header",
    string: "L\xE4gg till sp\xE5rningskod"
  },
  RLTaAR,
  fkplbE,
  nHmugP,
  ...
  "P/EDn1": {
    context: "order history message",
    string: "Order har betalats till fullo"
  },
  ubasgL,
  "2yV+s8": {
    context: "order history message",
  ...
  "v+Pkm+": {
    context: "field is optional",
    string: "*Valfritt. L\xE4gg till produkt i kollektion f\xF6r att hj\xE4lpa anv\xE4ndare att hitta den."
  },
  anK7jD,
  "3rIMq/": {
  ...
  "TfY/Pi": {
    context: "checkbox",
    string: "L\xE4gg till moms f\xF6r denna produkt"
  },
  CdIHMu,
  iYH3Y7,
  "8uo4v1": {
  ...
  "4EuJKs": {
    string: "Alla produkter anges med moms inkluderat"
  },
  "98isC5": {
    string: "Visa bruttopris f\xF6r kunder i butiken"
  },
  FNKhkx,
  "+OV+Gj": {
    context: "button",
...
//# sourceMappingURL=sv.1f75fee5.js.map
