...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "7d5cfbe3-bff5-4136-8314-6d2cfda59311", e._sentryDebugIdIdentifier = "sentry-dbid-7d5cfbe3-bff5-4136-8314-6d2cfda59311");
  } catch (e2) {
  }
}();
const PRXpBm = {
...
const oIMMcO = {
  ...
  string: "\u60A8\u7684\u5546\u5E97\u6C92\u6709\u8A2D\u7F6E\u5009\u5EAB\u3002\u60A8\u4ECD\u53EF\u5728\u4E0D\u63D0\u4F9B\u5EAB\u5B58\u6578\u91CF\u7684\u60C5\u6CC1\u4E0B\u8A2D\u7F6E\u8B8A\u9AD4\u3002"
};
const Gjo89T = {
  context: "header",
  string: "\u5009\u5EAB"
...
const D8nsBc = {
  context: "no warehouses info",
  string: "\u60A8\u7684\u5546\u5E97\u6C92\u6709\u8A2D\u7F6E\u5009\u5EAB\u3002\u5982\u8981\u65B0\u589E\u8B8A\u9AD4\u5EAB\u5B58\u8ACB\u5148<a>\u8A2D\u7F6E\u5009\u5EAB</a>"
};
const RLBLPQ = {
  context: "no warehouses info",
  string: "\u60A8\u7684\u5546\u5E97\u6C92\u6709\u8A2D\u7F6E\u5009\u5EAB\u3002\u5982\u8981\u65B0\u589E\u5546\u54C1\u5EAB\u5B58\u8ACB\u5148<a>\u8A2D\u7F6E\u5009\u5EAB</a>"
};
const qJedl0 = {
  context: "product label",
  string: "\u5DF2\u767C\u4F48"
...
const tTtoKd = {
  context: "error message",
  string: "\u62B1\u6B49\uFF0C\u60A8\u7684\u4F7F\u7528\u8005\u540D\u7A31\u548C\uFF0F\u6216\u5BC6\u78BC\u4E0D\u6B63\u78BA\u3002 \u8ACB\u518D\u8A66\u4E00\u6B21\u3002"
};
const ChGI4V = {
  context: "error message",
...
const i0AcKY = {
  ...
  string: "\u53EA\u662F\u70BA\u4E86\u8B93\u4F60\u77E5\u9053......\u4F60\u76EE\u524D\u5728\u6F14\u793A\u6A21\u5F0F\u3002 \u4F60\u53EF\u4EE5\u8A66\u73A9\u5F8C\u53F0\u7CFB\u7D71\uFF0C\u4F46\u7121\u6CD5\u4FDD\u5B58\u66F4\u6539\u3002 "
};
const Q8Qw5B = {
  string: "\u63CF\u8FF0"
};
...
const zhHant = {
  ...
  "0opVvi": {
    ...
    string: "{amount, plural,other {{amount} \u5F35\u8A02\u55AE}}"
  },
  rr8fyf,
  Q1Uzbb,
  "6L6Fy2": {
  ...
  "5LRkEs": {
    string: "\u65B0\u7684\u5F8C\u53F0\u548CGraphQL API\u662F\u9810\u89BD\u7248\u672C\u7684\u8EDF\u4EF6\u3002"
  },
  G7mu0y,
  QBxN6z,
  "I+UwqI": {
  ...
  LmKz3g,
  "/X8Mjx": {
    string: "\u8A66\u7528 <emphasis>GraphQL API</emphasis>"
  },
  xwEc8K,
  "4gZl/n": {
...
//# sourceMappingURL=zh-Hant.77d57a64.js.map
