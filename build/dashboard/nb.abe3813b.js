...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "aca98e62-4ff3-45c2-bd68-516840c98057", e._sentryDebugIdIdentifier = "sentry-dbid-aca98e62-4ff3-45c2-bd68-516840c98057");
  } catch (e2) {
  }
}();
const PRXpBm = {
...
const G7mu0y = {
  string: "GraphQL APIet er i beta. Det er ikke fullt optimalisert, og noen mutasjoner og sp\xF8rringer kan mangle."
};
const QBxN6z = {
...
const E54eoT = {
  string: "Endring av navigasjonsstrukturen gj\xF8res ved dra-og-slipp. Opprett et nytt menyelement og dra det til \xF8nsket plassering. Du kan flytte et element inni et annet for \xE5 opprette en trestruktur, samt flytter elementer opp og ned for \xE5 skape et hierarki"
};
const H3Uirw = {
...
const WwZfNK = {
  string: "Legg til en ny meny for \xE5 opprette en meny"
};
const ugnggZ = {
  string: "Meny opprettet"
};
const bj1U23 = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {menuItem}?"
};
const DWs4ba = {
...
const yOaNWB = {
  ...
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {name}?"
};
const LsgHmZ = {
...
const ixjvkM = {
  string: "Vi har opprettet din token. Pass p\xE5 \xE5 kopiere denne n\xE5, da du ikke vil kunne se den igjen senere."
};
const imYxM9 = {
  context: "header",
...
const k0rGBI = {
  string: "Tilgangstoken brukes for \xE5 autentisere servicekontoer"
};
const t9a9GQ = {
  string: "Vi har opprettet din token. Pass p\xE5 \xE5 kopiere denne n\xE5, da du ikke vil kunne se den igjen senere."
};
...
const h1rPPg = {
  ...
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette attributten {attributeName}?"
};
const jBu2yj = {
...
const Q7uuDr = {
  ...
  string: "Dette brukes internt. Pass p\xE5 at du ikke bruker mellomrom"
};
const l5V0QT = {
...
const cvbqJu = {
  context: "attribute",
  string: "Synlig p\xE5 Produktsiden i nettbutikken"
};
const ztQgD8 = {
...
const Q9wTrz = {
  context: "caption",
  string: "Hvis aktivert vil du kunne bruke denne attributten til \xE5 filtrere produkter i produktlisten"
};
const AgY5Mv = {
...
const JyQoES = {
  ...
  string: 'Er du sikker p\xE5 at du \xF8nsker \xE5 slette "{name}" verdien?'
};
const WWV8aZ = {
  context: "dialog title",
...
const no3Ygn = {
  string: 'Er du sikker p\xE5 at du \xF8nsker \xE5 slette "{name}" verdien? Hvis du sletter den vil du ikke kunne tildele den til andre produkter med "{attributeName}" attributten.'
};
const XYhE8p = {
...
const tTtoKd = {
  context: "error message",
  string: "Beklager, ditt brukernavn og/eller passord er feil. Vennligst pr\xF8v igjen"
};
const ChGI4V = {
  context: "error message",
...
const C0JLNW = {
  string: "Den gitte e-postadressen finnes ikke i v\xE5r database"
};
const hOxIeP = {
...
const wQdR8M = {
  string: "Legg til tittel og beskrivelse for \xE5 gj\xF8re det lettere for s\xF8kemotorer \xE5 finne denne kategorien"
};
const xo5UIb = {
  context: "dialog title",
...
const dJQxHt = {
  ...
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette kategorien {categoryName}?"
};
const vEYtiq = {
  string: "Kategorinavn"
};
...
const Rj8LxK = {
  string: "Legg til tittel og beskrivelse for \xE5 gj\xF8re det lettere for s\xF8kemotorer \xE5 finne denne kolleksjonen"
};
const Fxa6xp = {
  context: "page header",
...
const MxhVZv = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette bildet i kolleksjonen?"
};
const I1Mz7h = {
  string: "Manage Collection Channel Availability"
};
const pVFoOk = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {collectionName}?"
};
const ttMauu = {
  context: "window title",
  string: "Opprett kolleksjon"
...
const fP9FXB = {
  context: "input label",
  string: "S\xF8k i Attributter"
};
const auxEP1 = {
  context: "input placeholder",
  string: "S\xF8k etter attributtnavn"
};
const QM9P8G = {
  context: "dialog header",
...
const sf6FMK = {
  ...
  string: "S\xF8k etter kategorinavn, etc..."
};
const XLYssG = {
...
const f0hXz4 = {
  context: "dialog header",
  string: "S\xF8k i Kolleksjon"
};
const JiRKgJ = {
  context: "dialog search placeholder",
  string: "S\xF8k etter kolleksjonsnavn, etc..."
};
const cryH86 = {
...
const SHm7ee = {
  string: "S\xF8k etter produktnavn, attributt, produkttype, osv..."
};
const dTCDMn = {
  context: "dialog header",
  string: "Tildel Produkt"
...
const UaYJJ8 = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette s\xF8kefeltet {name}?"
};
const LmKz3g = {
  string: "Storefront"
};
...
const NxeDbG = {
  ...
  string: "Slipp her for \xE5 laste opp"
};
const LkuDEb = {
...
const TpPx7V = {
  context: "navigator placeholder",
  string: "S\xF8k etter Kunde"
};
const BooQvo = {
  context: "navigator placeholder",
  string: "Type {key} for \xE5 se tilgjengelige handlinger"
};
const AOI4LW = {
  context: "navigator placeholder",
  string: "S\xF8k i Katalog"
};
const YYkkhx = {
...
const Gxm7Qx = {
  ...
  string: "Navigator er her for \xE5 hjelpe"
};
const ccXLVi = {
  string: "Kategori"
};
...
const IyHQr0 = {
  ...
  string: "G\xE5 til ordre #{orderNumber}"
};
const kbkjEc = {
...
const liLrVs = {
  ...
  string: "Lagre Egendefinert S\xF8k"
};
const QcIFCs = {
  context: "save search tab",
  string: "S\xF8k i Navn"
};
const w2Cewo = {
  string: "Tittel for s\xF8kemotor"
};
const CXTIq8 = {
  string: "Beskrivelse for s\xF8kemotor"
};
const s5Imt5 = {
  context: "button",
...
const TGX4T1 = {
  string: "Forh\xE5ndsvisning for s\xF8kemotor"
};
const IoDlcd = {
  string: "Slug"
};
...
const kErneR = {
  string: "Denne kunden har ingen adresser i sin adressebok. Du kan legge til en ny adresse ved \xE5 trykke p\xE5 knappen nedenfor."
};
const n5vskv = {
...
const hMRP6J = {
  string: "Prim\xE6r adresse"
};
const VyzsWZ = {
  string: "Prim\xE6r fakturaadresse"
};
const nLML8Y = {
  string: "Prim\xE6r Fraktadresse"
};
const puikeb = {
  context: "button",
...
const w3sGrD = {
  string: "Skriv inn annen informasjon ang\xE5ende denne kunden"
};
const N76zUg = {
  context: "page header",
...
const dGqEJ9 = {
  ...
  string: "S\xF8k etter land"
};
const wgA48T = {
  context: "country selection",
  string: "Land A til \xC5"
};
const AVF5T5 = {
...
const s51tHd = {
  context: "limit voucher",
  string: "Begrensninger p\xE5 Bruk"
};
const o8S0Ac = {
...
const ObRk1O = {
  string: "Hvis dette valget er deaktivert vil rabatter p\xE5f\xF8res hvert enkelt kvalifisert produkt"
};
const bP7ZLP = {
...
const rNzkIt = {
  context: "dialog content",
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {saleName}?"
};
const opIDox = {
...
const NEJo1I = {
  context: "dialog content",
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {voucherCode}?"
};
const EM730i = {
  string: "Manage Channel Availability"
};
...
const E9Jssl = {
  string: "Ingen ordre klare til \xE5 sendes"
};
const bFhzRX = {
...
const mxtAFx = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette ordreutkast #{orderNumber}?"
};
const lVwmf5 = {
...
const M9LXb5 = {
  ...
  string: "Ingen tilgjengelige frakt\xF8rer"
};
const xUvWaP = {
...
const wOeIR4 = {
  context: "order history message",
  string: "Varelageret \xF8kt med {quantity} produkter"
};
const oQ27V4 = {
  context: "order history message",
...
const NWxomz = {
  string: "Status p\xE5 forsendelse"
};
const PHUcrU = {
...
const uUsZ7m = {
  context: "order payment",
  string: "Forh\xE5ndsautorisert bel\xF8p"
};
const HaQ8cg = {
  context: "button",
  string: "Refusjon"
...
const jZbT0O = {
  string: "Legg til tittel og beskrivelse for \xE5 gj\xF8re det lettere for s\xF8kemotorer \xE5 fine denne siden"
};
const GZgjK7 = {
  context: "page",
  string: "vil v\xE6re synlig fra {date}"
};
const X26jCC = {
  context: "page label",
  string: "Synlig"
...
const JRfJD9 = {
  string: "Pluginen kan slutte \xE5 fungere hvis du fjerner verdien fra dette feltet. Er du sikker p\xE5 at du \xF8nsker \xE5 fortsette?"
};
const YQ3EXR = {
...
const H5yp8O = {
  context: "label",
  string: "Navn p\xE5 produkttype"
};
const rpFdD1 = {
  string: "S\xF8k etter Produkttype"
};
const QY7FSs = {
  context: "button",
  string: "opprett produkttype"
...
const VOiUXQ = {
  string: "Brukes for \xE5 kalkulere satser for frakt av denne produkttypen hvis vekt ikke oppgitt"
};
const zCb8fX = {
  string: "Vekt"
};
...
const LKoIB1 = {
  string: "Legg til tittel og beskrivelse for \xE5 gj\xF8re det letter for s\xF8kemotorer \xE5 finne dette produktet"
};
const JGm7E5 = {
  context: "option",
...
const L5rthO = {
  string: "Angi unik lagerverdi basert p\xE5 attributt for alle SKUer"
};
const STp3Hl = {
...
const rIJbNC = {
  string: "Bruk varianter for ulike variasjoner av et produkt, som f.eks forskjellige st\xF8rrelser eller farger"
};
const JtZ71e = {
...
const kFYlu2 = {
  string: "Saleor kj\xF8rer i skrivebeskyttet modus. Endringer som gj\xF8res blir ikke lagret."
};
const rqtV5d = {
  context: "order status",
...
const LVa5ew = {
  string: "Saleor st\xF8tte p\xE5 et uventet problem"
};
const AQFMYU = {
...
const qEJT8e = {
  string: "Det nye passordet m\xE5 minst inneholde 8 tegn"
};
const GXdwyR = {
  context: "input label",
...
const JJgJwi = {
  string: "Ved \xE5 velge dette vil spr\xE5ket p\xE5 ditt dashboard endres"
};
const e822us = {
...
const fzpXvv = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 fjerne avatar for {email}?"
};
const VKWPBf = {
  context: "dialog header",
...
const gxPjIQ = {
  string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {email} fra personalet?"
};
const QirE3M = {
  string: "Startdato"
};
...
const LWmYSU = {
  string: "Oversettelser fullf\xF8rt"
};
const X6PF8z = {
...
const cd13nN = {
  ...
  string: "Alle attributter m\xE5 ha en verdi"
};
const lLwtgs = {
...
const sZ27WU = {
  context: "error message",
  string: "Kun forh\xE5ndsautoriserte betalinger kan annulleres"
};
const gKdGxP = {
  context: "error message",
  string: "Kun forh\xE5ndsautoriserte betalinger kan belastes"
};
const V2BBQu = {
...
const tA5HJx = {
  ...
  string: "den hemmelige n\xF8kkelen brukes til \xE5 lage en hash-signatur for hver payload. *valgfritt felt"
};
const WDy0tF = {
  context: "section header",
...
const D0KaT6 = {
  context: "webhook input label",
  string: "Navn p\xE5 Webhoo"
};
const IBCBi1 = {
  context: "webhook active description",
  string: "Hvis du \xF8nsker \xE5 deaktivere denne webhooken, fjern avmerkingen i boksen nedenfor."
};
const wbjuR4 = {
...
const nb = {
  ...
  mDgOmP,
  "19/lwV": {
    string: "Bestem attributter som skal brukes for \xE5 opprette produkttyper"
  },
  "8vJCJ4": {
  ...
  "G/SYtU": {
    string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette menyen {menuName}?"
  },
  QzseV7,
  E54eoT,
  H3Uirw,
  ...
  Urh2N3,
  "28GZnc": {
    string: "Start \xE5 skrive for \xE5 s\xF8ke..."
  },
  "0Vyr8h": {
  ...
  "2VSP8C": {
    ...
    string: "Er du sikkert p\xE5 at du \xF8nsker \xE5 slette token {token}?"
  },
  "ac+Y98": {
  ...
  "2ob30/": {
    string: "Det gikk bra! Om noen f\xE5 minutter vil du motta en e-post med instruksjoner om hvordan du tilbakestiller ditt passord."
  },
  C0JLNW,
  hOxIeP,
  "0OfZJA": {
  ...
  "e+L+q3": {
    string: "Husk at dette vil ogs\xE5 slette alle produkter som ligger i denne kategorien."
  },
  sG0w22,
  xRkj2h,
  KeO51o,
  ...
  "EM+30g": {
    ...
    string: "V\xE5r nye funksjon vil hjelpe deg med dine daglige gj\xF8rem\xE5l. Kj\xF8r Navigator ved \xE5 bruke snarveien {keyboardShortcut}."
  },
  me585h,
  Gxm7Qx,
  ccXLVi,
  ...
  "3TlhJS": {
    ...
    string: "S\xF8k Kommando"
  },
  DHBlFi,
  "Xel9C+": {
    context: "navigator default mode description",
    string: "S\xF8k etter Visninger og Handlinger"
  },
  iAvKNf,
  usSkzP,
  k8bltk,
  ...
  ChAjJu,
  "s/sTT6": {
    string: "Hvis tom vil forh\xE5ndsvisningen vise hva som vil bli generert automatisk"
  },
  "450Fty": {
    string: "Ingen"
  },
  ...
  MpR4zK,
  "y/UWBR": {
    string: "Det er ingen adresser \xE5 vise for denne kunden"
  },
  CWqmRU,
  hMRP6J,
  VyzsWZ,
  ...
  jGGnSZ,
  "wNQzS/": {
    string: "Prim\xE6radressen for denne kunden"
  },
  fjPWOA,
  qNcoRY,
  "uUQ+Al": {
  ...
  "2p0tZx": {
    ...
    string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {email}?"
  },
  ey0lZj,
  qLOBff,
  nX2pCU,
  "/kWzY1": {
    string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette denne adressen fra brukerens adressebok?"
  },
  PXatmC,
  ftcHpD,
  N2SbNc,
  ...
  E9Jssl,
  "5dyOs0": {
    string: "Ingen betalinger venter p\xE5 \xE5 bli belastet"
  },
  bFhzRX,
  c0H45L,
  md326v,
  ...
  "2yV+s8": {
    context: "order history message",
    string: "Betalingen ble gjennomf\xF8rt"
  },
  aq5ZiN,
  hWO1SD,
  "GVM/fi": {
  ...
  OhdPS1,
  "euRfu+": {
    string: "Er du sikker p\xE5 at du \xF8nsker \xE5 annullere denne betalingen?"
  },
  KszPFx,
  BZ7BkQ,
  "V+gwx7": {
    context: "order payment",
    string: "Belastet bel\xF8p"
  },
  ghGLbJ,
  u0S2be,
  pr513b,
  ...
  "4B32Ba": {
    context: "delete page",
    string: "Er du sikker p\xE5 at du \xF8nsker \xE5 slette {title}?"
  },
  "41z2Qi": {
    context: "notification",
  ...
  "v+Pkm+": {
    context: "field is optional",
    string: "*Valgfritt. \xC5 legge produktet til i en kolleksjon gj\xF8r det lettere for kunden \xE5 finne det"
  },
  anK7jD,
  "3rIMq/": {
  ...
  L5rthO,
  "EGG8f+": {
    string: "Angi unik pris basert p\xE5 attributt for alle SKUer"
  },
  STp3Hl,
  "+bFHzi": {
    context: "button",
  ...
  T6dXGG,
  "VEext+": {
    string: "Er du sikker p\xE5 at \xF8nsker \xE5 slette dette bildet?"
  },
  MyM2oR,
  PXx4Jk,
  NBP8uu,
  ...
  "TKmub+": {
    string: "Dette feltet er p\xE5krevd"
  },
  "4Dc2j0": {
    context: "order status",
    string: "Returned"
  ...
  "5ZvuVw": {
    string: "Ingen produkter som matcher den gitte sp\xF8rringen ble funnet"
  },
  FzEew9,
  xZhxBJ,
  "Gg4+K7": {
  ...
  pwqwcy,
  "qf/m5l": {
    string: "Er du sikkert p\xE5 at du \xF8nsker \xE5 slette fraktsonen {shippingZoneName}?"
  },
  "k3EI/U": {
    context: "dialog header",
  ...
  QUyUJy,
  "bh+Keo": {
    string: "{numberOfFields} Oversettelser, {numberOfTranslatedFields} Gjennomf\xF8rt"
  },
  Xtd0AT,
  "/vCXIP": {
    string: "Oversettelse"
...
//# sourceMappingURL=nb.abe3813b.js.map
