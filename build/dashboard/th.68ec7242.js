...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "e66eed6d-7e39-42d0-bd56-5d9ccf0d4e3e", e._sentryDebugIdIdentifier = "sentry-dbid-e66eed6d-7e39-42d0-bd56-5d9ccf0d4e3e");
  } catch (e2) {
  }
}();
const PRXpBm = {
  context: "dialog header",
  string: "\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E0B\u0E37\u0E49\u0E2D"
};
const ll2dE6 = {
...
const eWV760 = {
  string: "\u0E21\u0E35\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E17\u0E35\u0E48\u0E15\u0E23\u0E07\u0E01\u0E31\u0E1A slug \u0E19\u0E35\u0E49\u0E2D\u0E22\u0E39\u0E48\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A\u0E41\u0E25\u0E49\u0E27"
};
const rKf4LU = {
  context: "dialog title",
  string: "\u0E25\u0E1A\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E40\u0E2B\u0E25\u0E48\u0E32\u0E19\u0E35\u0E49"
};
const JI2Xwp = {
  context: "dialog title",
  string: "\u0E25\u0E1A\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30"
...
const h1rPPg = {
  ...
  string: "\u0E04\u0E38\u0E13\u0E41\u0E19\u0E48\u0E43\u0E08\u0E27\u0E48\u0E32\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E25\u0E1A {attributeName}"
};
const jBu2yj = {
...
const dKPMyh = {
  context: "tab name",
  string: "\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E17\u0E31\u0E49\u0E07\u0E2B\u0E21\u0E14"
};
const IGvQ8k = {
  context: "button",
  string: "\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30"
};
const rvk9ls = {
...
const ErNH3D = {
  string: "\u0E42\u0E1B\u0E23\u0E14\u0E23\u0E30\u0E1A\u0E38\u0E27\u0E48\u0E32\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E19\u0E35\u0E49\u0E08\u0E30\u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E17\u0E35\u0E48\u0E44\u0E2B\u0E19\u0E1A\u0E49\u0E32\u0E07\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A Saleor"
};
const nwvQPg = {
  context: "section header",
  string: "Organization"
...
const bS7A8u = {
  ...
  string: "\u0E40\u0E1E\u0E34\u0E48\u0E21\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E2A\u0E16\u0E32\u0E19\u0E30\u0E08\u0E31\u0E14\u0E2A\u0E48\u0E07\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32"
};
const dTkmON = {
  context: "edit tracking button",
  string: "\u0E41\u0E01\u0E49\u0E44\u0E02\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E15\u0E34\u0E14\u0E15\u0E32\u0E21\u0E2A\u0E16\u0E32\u0E19\u0E30\u0E08\u0E31\u0E14\u0E2A\u0E48\u0E07"
};
const EHsnZX = {
  context: "dialog description",
...
const V76IV7 = {
  ...
  string: "\u0E15\u0E31\u0E27\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32"
};
const rbkmfG = {
  context: "button",
  string: "\u0E25\u0E1A\u0E15\u0E31\u0E27\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32"
};
const WwNtFn = {
...
const IFWHn0 = {
  context: "error message",
  string: "\u0E17\u0E35\u0E48\u0E2D\u0E22\u0E39\u0E48\u0E08\u0E31\u0E14\u0E2A\u0E48\u0E07\u0E1A\u0E34\u0E25\u0E44\u0E21\u0E48\u0E44\u0E14\u0E49\u0E15\u0E31\u0E49\u0E07\u0E44\u0E27\u0E49\u0E04\u0E48\u0E30"
};
const ij7olm = {
  context: "error message",
...
const VEE4gD = {
  context: "error message",
  string: "\u0E27\u0E34\u0E18\u0E35\u0E08\u0E31\u0E14\u0E2A\u0E48\u0E07\u0E44\u0E21\u0E48\u0E2A\u0E32\u0E21\u0E32\u0E23\u0E16\u0E43\u0E0A\u0E49\u0E44\u0E14\u0E49\u0E01\u0E31\u0E1A\u0E17\u0E35\u0E48\u0E2D\u0E22\u0E39\u0E48\u0E08\u0E31\u0E14\u0E2A\u0E48\u0E07"
};
const ychKsb = {
  context: "error message",
...
const Z6QAbw = {
  string: "\u0E15\u0E31\u0E27\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E19\u0E35\u0E49\u0E44\u0E21\u0E48\u0E21\u0E35\u0E40\u0E19\u0E37\u0E49\u0E2D\u0E2B\u0E32\u0E43\u0E19\u0E23\u0E39\u0E1B\u0E41\u0E1A\u0E1A\u0E14\u0E34\u0E08\u0E34\u0E15\u0E2D\u0E25\u0E04\u0E2D\u0E19\u0E40\u0E17\u0E19\u0E15\u0E4C"
};
const i3Mvj8 = {
  context: "product attribute error",
  string: "\u0E15\u0E31\u0E27\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32\u0E19\u0E35\u0E49\u0E21\u0E35\u0E2D\u0E22\u0E39\u0E48\u0E41\u0E25\u0E49\u0E27\u0E43\u0E19\u0E23\u0E30\u0E1A\u0E1A"
};
const iUy2dx = {
...
const th = {
  ...
  mDgOmP,
  "19/lwV": {
    string: "\u0E23\u0E30\u0E1A\u0E38\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E43\u0E0A\u0E49\u0E43\u0E19\u0E01\u0E32\u0E23\u0E2A\u0E23\u0E49\u0E32\u0E07\u0E0A\u0E19\u0E34\u0E14\u0E2A\u0E34\u0E19\u0E04\u0E49\u0E32"
  },
  "8vJCJ4": {
  ...
  Urh2N3,
  "28GZnc": {
    string: "\u0E1E\u0E34\u0E21\u0E1E\u0E4C\u0E40\u0E25\u0E22\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E23\u0E34\u0E48\u0E21\u0E15\u0E49\u0E19\u0E04\u0E49\u0E19\u0E2B\u0E32..."
  },
  "0Vyr8h": {
  ...
  eWV760,
  "J/QqOI": {
    string: "\u0E04\u0E48\u0E32\u0E17\u0E35\u0E48\u0E43\u0E2A\u0E48\u0E21\u0E35\u0E2D\u0E22\u0E39\u0E48\u0E41\u0E25\u0E49\u0E27\u0E43\u0E19\u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E19\u0E35\u0E49"
  },
  "lG/MDw": {
    context: "dialog content",
    string: "{counter,plural,other {\u0E04\u0E38\u0E13\u0E41\u0E19\u0E48\u0E43\u0E08\u0E27\u0E48\u0E32\u0E15\u0E49\u0E2D\u0E07\u0E01\u0E32\u0E23\u0E25\u0E1A {diaplayQuantity} \u0E04\u0E38\u0E13\u0E25\u0E31\u0E01\u0E29\u0E13\u0E30\u0E40\u0E2B\u0E25\u0E48\u0E32\u0E19\u0E35\u0E49}}"
  },
  rKf4LU,
  JI2Xwp,
  h1rPPg,
  ...
  "P/EDn1": {
    context: "order history message",
    string: "\u0E04\u0E33\u0E2A\u0E31\u0E48\u0E07\u0E0B\u0E37\u0E49\u0E2D\u0E19\u0E35\u0E49\u0E44\u0E14\u0E49\u0E23\u0E31\u0E1A\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E07\u0E34\u0E19\u0E04\u0E23\u0E1A\u0E16\u0E49\u0E27\u0E19\u0E41\u0E25\u0E49\u0E27"
  },
  ubasgL,
  "2yV+s8": {
    context: "order history message",
...
//# sourceMappingURL=th.68ec7242.js.map
