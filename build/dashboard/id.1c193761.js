...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "5f53a6e0-355a-4fc9-b6e0-7e45003bef68", e._sentryDebugIdIdentifier = "sentry-dbid-5f53a6e0-355a-4fc9-b6e0-7e45003bef68");
  } catch (e2) {
  }
}();
const PRXpBm = {
...
const hpMcW8 = {
  string: "Tentukan bagaimana pengguna dapat menavigasi toko Anda"
};
const ivJ1qt = {
  string: "Kelola izin grup kamu dan izin mereka"
};
const n0RwMK = {
  string: "Tentukan jenis produk yang Anda jual"
};
const zxs6G3 = {
  string: "Kelola cara Anda mengirimkan pesanan"
};
const RQUkVW = {
  string: "Kelola karyawan Anda dan izin mereka"
};
const EIULpW = {
  string: "Kelola bagaimana toko Anda mengenakan pajak"
};
const m19JfL = {
  string: "Lihat dan perbarui plugin Anda dan pengaturannya."
};
const yJynYK = {
...
const wWTUrM = {
  string: "Tidak ditemukan aktivitas"
};
const zWgbGg = {
  string: "Hari ini"
};
const By5ZBp = {
  context: "header",
  string: "Halo, {userName}"
};
const aCX8rl = {
  context: "subheader",
  string: "Berikut ini adalah beberapa informasi yang kami kumpulkan terkait toko Anda"
};
const rr8fyf = {
  context: "header",
...
const G7mu0y = {
  string: "API GraphQL adalah kualitas beta. Ini tidak sepenuhnya dioptimalkan dan beberapa mutasi atau kueri mungkin hilang."
};
const QBxN6z = {
...
const H3Uirw = {
  ...
  string: "Tambahkan Item"
};
const fzDI3A = {
  context: "add link to navigation",
  string: "Tautan ke: {url}"
};
const KKQUMK = {
...
const WwZfNK = {
  string: "Tambah item baru untuk mulai membuat menu"
};
const ugnggZ = {
  string: "Menu yang dibuat"
};
const bj1U23 = {
  string: "Apakah Anda yakin ingin menghapus {menuName}?"
};
const DWs4ba = {
  string: "Tidak ada menu yang ditemukan"
};
const JXRYQg = {
  context: "button",
  string: "Buat Menu"
...
const ppLwx3 = {
  ...
  string: "Kategori ({quantity})"
};
const QdGzUf = {
  context: "number of collections",
  string: "Koleksi ({quantity})"
};
const bNw8PM = {
  context: "number of products",
  string: "Produk ({quantity})"
};
const HVlMK2 = {
...
const yOaNWB = {
  ...
  string: "Apakah Anda yakin ingin menghapus {name}?"
};
const LsgHmZ = {
...
const eWV760 = {
  string: "Atribut dengan slug ini sudah ada"
};
const rKf4LU = {
  context: "dialog title",
  string: "Hapus atribut"
};
const JI2Xwp = {
  context: "dialog title",
  string: "Hapus atribut"
...
const h1rPPg = {
  ...
  string: "Kamu yakin mau menghapus {attributeName}?"
};
const jBu2yj = {
...
const Q7uuDr = {
  ...
  string: "Ini digunakan secara internal. Pastikan kamu tidak menggunakan spasi"
};
const l5V0QT = {
...
const cvbqJu = {
  context: "attribute",
  string: "Terlihat di Halaman Produk pada Storefront"
};
const ztQgD8 = {
...
const jswILH = {
  ...
  string: "Tambahkan ke Opsi Kolom"
};
const AzMSmb = {
  context: "caption",
  string: "Jika diaktifkan, atribut ini dapat digunakan sebagai kolom di tabel produk"
};
const lCxfDe = {
  context: "attribute properties regarding dashboard",
  string: "Properti Dashboard"
};
const Q9wTrz = {
  context: "caption",
  string: "Jika diaktifkan, kamu bisa menggunakan atribut ini untuk memfilter produk di daftar produk."
};
const AgY5Mv = {
  context: "attribute properties regarding storefront",
  string: "Properti Storefront"
};
const cJ5ASN = {
...
const JyQoES = {
  ...
  string: 'Kamu yakin mau menghapus nilai "{name}"?'
};
const WWV8aZ = {
  context: "dialog title",
  string: "Hapus nilai atribut"
};
const no3Ygn = {
  string: 'Kamu yakin mau menghapus nilai "{name}"? Jika dihapus kamu tidak akan dapat menetapkannya ke salah satu produk dengan atribut "{attributeName}".'
};
const XYhE8p = {
...
const Ev6SEF = {
  string: "Kata Sandi Baru"
};
const S22jIs = {
  context: "button",
  string: "Atur kata sandi baru"
};
const WhKGPA = {
  context: "page title",
...
const C0JLNW = {
  string: "Alamat email yang diberikan tidak ada di basis data kami."
};
const hOxIeP = {
  string: "Ketersediaan"
};
...
const DP6b8U = {
  context: "section header",
  string: "Gambar Latar (opsional)"
};
const wQdR8M = {
  string: "Tambahkan judul mesin pencari dan deskripsi untuk membuat kategori ini lebih mudah ditemukan"
};
const xo5UIb = {
  context: "dialog title",
  string: "Hapus kategori"
};
const dJQxHt = {
  context: "delete category",
  string: "Kamu yakin mau menghapus {categoryName}?"
};
const vEYtiq = {
...
const vof5TR = {
  context: "button",
  string: "Buat kategori"
};
const JiXNEV = {
  string: "Cari Kategori"
};
const vy7fjd = {
  context: "tab name",
  string: "Semua Kategori"
};
const dM86a2 = {
...
const Fxa6xp = {
  context: "page header",
  string: "Tambah Koleksi"
};
const G4g5Ii = {
  context: "tab name",
  string: "Semua Koleksi"
};
const s97tLq = {
...
const Q8wHwJ = {
  string: "Koleksi dihapus"
};
const MxhVZv = {
  string: "Kamu yakin mau menghapus gambar koleksi?"
};
const I1Mz7h = {
...
const yT5zvU = {
  string: "{counter,plural,other {Kamu yakin mau menghapus {displayQuantity} koleksi?}}"
};
const Ykw8k5 = {
  context: "dialog title",
  string: "Hapus koleksi"
};
const C7eDb9 = {
...
const VyzsWZ = {
  string: "Alamat Penagihan Utama"
};
const nLML8Y = {
  string: "Alamat Pengiriman Utama"
};
const puikeb = {
  context: "button",
...
const hLOEeb = {
  context: "button",
  string: "Atur sebagai alamat penagihan utama"
};
const BfJGij = {
  context: "header",
...
const E9Jssl = {
  string: "Tidak ada pesanan yang siap diselesaikan"
};
const bFhzRX = {
...
const GLX9II = {
  ...
  string: "Sama seperti alamat pengiriman"
};
const Qovenh = {
...
const bS7A8u = {
  ...
  string: "Tambahkan pelacakan"
};
const dTkmON = {
  context: "edit tracking button",
  string: "Edit pelacakan"
};
const EHsnZX = {
  context: "dialog description",
...
const XJSRDK = {
  context: "payment status",
  string: "Pengembalian dana sepenuhnya"
};
const nwnwJ0 = {
  context: "payment status",
  string: "Refused"
...
const FNKhkx = {
  string: "Beban pajak pada tarif pengiriman"
};
const HtQGEH = {
...
const IFWHn0 = {
  context: "error message",
  string: "Alamat penagihan belum diisi"
};
const ij7olm = {
  context: "error message",
...
const Xb6BJ9 = {
  context: "error message",
  string: "Pembayaran manual tidak dapat dikembalikan"
};
const WzA5Ll = {
...
const sZ27WU = {
  context: "error message",
  string: "Hanya pembayaran pra-otorisasi yang dapat dibatalkan"
};
const gKdGxP = {
  context: "error message",
  string: "Hanya pembayaran pra-otorisasi yang dapat direkam"
};
const V2BBQu = {
...
const VEE4gD = {
  context: "error message",
  string: "Metode pengiriman tidak valid untuk alamat pengiriman yang dipilih"
};
const ychKsb = {
  context: "error message",
...
const id = {
  ...
  mDgOmP,
  "19/lwV": {
    string: "Tentukan atribut yang digunakan untuk membuat jenis produk"
  },
  "8vJCJ4": {
  ...
  zxs6G3,
  "5BajZK": {
    string: "Lihat dan perbarui pengaturan situs Anda"
  },
  RQUkVW,
  EIULpW,
  "5RmuD+": {
    string: "Kelola dan perbarui informasi gudang Anda"
  },
  m19JfL,
  yJynYK,
  ojHyj3,
  ...
  "0opVvi": {
    ...
    string: "{amount, plural,other {{amount} Dipesan}}"
  },
  rr8fyf,
  Q1Uzbb,
  "6L6Fy2": {
  ...
  "5LRkEs": {
    string: "Dasbor baru dan API GraphQL adalah perangkat lunak berkualitas pratinjau."
  },
  G7mu0y,
  QBxN6z,
  "I+UwqI": {
  ...
  "G/SYtU": {
    string: "Apakah Anda yakin ingin menghapus menu {menuName}?"
  },
  QzseV7,
  E54eoT,
  H3Uirw,
  ...
  Urh2N3,
  "28GZnc": {
    string: "Mulai mengetik untuk memulai pencarian ..."
  },
  "0Vyr8h": {
  ...
  "P/oGtb": {
    context: "product availability",
    string: "Tersedia untuk pembelian"
  },
  KupNHw,
  jxoMLL,
  YVIajc,
  ...
  eWV760,
  "J/QqOI": {
    string: "Nilai ini sudah ada dalam atribut ini"
  },
  "lG/MDw": {
    context: "dialog content",
    string: "{counter,plural,other {Kamu yakin mau menghapus {displayQuantity} atribut?}}"
  },
  rKf4LU,
  JI2Xwp,
  h1rPPg,
  ...
  "PsRG+v": {
    ...
    string: "Dapat difilter di Storefront"
  },
  rvk9ls,
  HQR2y0,
  cvbqJu,
  ...
  NUevU9,
  "jTifz+": {
    string: "Berhasil membuat atribut"
  },
  "7H2D5m": {
  ...
  "7Chrsf": {
    string: "Kata sandi tidak cocok"
  },
  WhKGPA,
  lm9NSK,
  "Yy/yDL": {
    string: "Atur ulang kata sandi"
  },
  "54M0Gu": {
  ...
  "2oyWT9": {
    context: "button",
    string: "Kembali ke login"
  },
  "2ob30/": {
    string: "Berhasil! Dalam beberapa menit kamu akan menerima pesan instruksi bagaimana cara menyetel ulang kata sandimu."
  },
  C0JLNW,
  hOxIeP,
  "0OfZJA": {
  ...
  xl7Fag,
  "Pp/7T7": {
    string: "{counter,plural,other {Kamu yakin mau menghapus {displayQuantity} kategori?}}"
  },
  HvJPcU,
  KCjd1o,
  "3DGvA/": {
  ...
  LmKz3g,
  "/X8Mjx": {
    string: "Bermain dengan <emphasis>GraphQL API</emphasis>"
  },
  xwEc8K,
  "4gZl/n": {
  ...
  ChAjJu,
  "s/sTT6": {
    string: "Jika kosong, pratinjau menunjukkan apa yang akan dibuat otomatis."
  },
  "450Fty": {
    string: "None"
  },
  ...
  "+7OsyM": {
    context: "button",
    string: "Atur sebagai alamat pengiriman utama"
  },
  BfJGij,
  Zd3Eew,
  bHdFph,
  ...
  giF5UV,
  "51HE+Q": {
    string: "Tidak ditemukan penjualan"
  },
  iBSq6l,
  "WkxE8/": {
  ...
  E9Jssl,
  "5dyOs0": {
    string: "Tidak ada pembayaran yang menunggu di-capture"
  },
  bFhzRX,
  c0H45L,
  md326v,
  ...
  "P/EDn1": {
    context: "order history message",
    string: "Pesanan sudah dibayar penuh"
  },
  ubasgL,
  "2yV+s8": {
    context: "order history message",
  ...
  "TfY/Pi": {
    context: "checkbox",
    string: "Tagihan pajak untuk produk ini"
  },
  CdIHMu,
  iYH3Y7,
  "8uo4v1": {
  ...
  "4EuJKs": {
    string: "Semua harga produk dimasukkan dengan termasuk pajak"
  },
  "98isC5": {
    string: "Menampilkan harga gross kepada pelanggan di etalase"
  },
  FNKhkx,
  "+OV+Gj": {
    context: "button",
...
//# sourceMappingURL=id.1c193761.js.map
