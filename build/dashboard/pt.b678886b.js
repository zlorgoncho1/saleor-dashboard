...
!function() {
  try {
    ...
    n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "1dbb16ae-a8c8-44eb-b660-20557ac2cd28", e._sentryDebugIdIdentifier = "sentry-dbid-1dbb16ae-a8c8-44eb-b660-20557ac2cd28");
  } catch (e2) {
  }
}();
const PRXpBm = {
...
const ivJ1qt = {
  string: "Modifique grupos e as suas permiss\xF5es"
};
const n0RwMK = {
...
const RQUkVW = {
  string: "Defina empregados e as suas permiss\xF5es"
};
const EIULpW = {
  string: "Defina como a loja gere os impostos"
};
const m19JfL = {
  string: "Veja e edite os plugins e as suas op\xE7\xF5es"
};
const yJynYK = {
...
const By5ZBp = {
  context: "header",
  string: "Ol\xE1, {userName}"
};
const aCX8rl = {
  context: "subheader",
  string: "Aqui est\xE1 alguma informa\xE7\xE3o que reunimos acerca da sua loja"
};
const rr8fyf = {
  context: "header",
...
const dEUZg2 = {
  context: "header",
  string: "Items do menu"
};
const WwZfNK = {
  string: "Adicionar item de menu para criar menu"
};
const ugnggZ = {
  string: "Menu criado"
};
const bj1U23 = {
  string: "Tem a certeza que quer eliminar {menuName}?"
};
const DWs4ba = {
...
const Uo5MoU = {
  context: "product field",
  string: "imagens de varia\xE7\xF5es"
};
const XBwpUv = {
  context: "product field",
...
const QdGzUf = {
  ...
  string: "Colec\xE7\xF5es ({quantity})"
};
const bNw8PM = {
...
const xOEZjV = {
  ...
  string: "Etiqueta por omiss\xE3o"
};
const P79U4b = {
  context: "attribute's slug short code label",
  string: "C\xF3digo de atributo"
};
const Q7uuDr = {
  context: "attribute slug input field helper text",
  string: "Isto \xE9 utilizado internamente. N\xE3o utilizar espa\xE7os"
};
const l5V0QT = {
...
const cKjFfl = {
  context: "product attribute type",
  string: "Selec\xE7\xE3o m\xFAltipla"
};
const SNiyXb = {
...
const njBulj = {
  ...
  string: "\xC9 necess\xE1rio o valor"
};
const cy8sV7 = {
...
const cvbqJu = {
  context: "attribute",
  string: "Vis\xEDvel na p\xE1gina de produto na loja"
};
const ztQgD8 = {
...
const tTtoKd = {
  context: "error message",
  string: "O seu nome de utilizador e/ou senha est\xE3o incorrectos. Por favor tente outra vez."
};
const ChGI4V = {
  context: "error message",
...
const C0JLNW = {
  string: "O endere\xE7o de e-mail n\xE3o existe na nossa base de dados."
};
const hOxIeP = {
...
const wQdR8M = {
  string: "Adicione um t\xEDtulo e descri\xE7\xE3o para o motor de buscar encontrar esta categoria mais facilmente"
};
const xo5UIb = {
  context: "dialog title",
  string: "Apagar categoria"
};
const dJQxHt = {
  context: "delete category",
  string: "Tem a certeza que pretende apagar {categoryName}?"
};
const vEYtiq = {
...
const rrbzZt = {
  string: "Nenhuma subcategoria encontrada"
};
const BHQrgz = {
...
const HvJPcU = {
  string: "Categoria apagada"
};
const KCjd1o = {
  context: "dialog title",
  string: "Apagar produtos"
};
const sG0w22 = {
  context: "dialog title",
  string: "Apagar categorias"
};
const xRkj2h = {
  string: "Tem a certeza que pretende apagar {categoryName}?"
};
...
const Rj8LxK = {
  string: "Adicione um t\xEDtulo e descri\xE7\xE3o para o motor de busca encontrar esta cole\xE7\xE3o mais facilmente"
};
const Fxa6xp = {
  context: "page header",
  string: "Adicionar Cole\xE7\xE3o"
};
const G4g5Ii = {
  context: "tab name",
  string: "Todas as cole\xE7\xF5es"
};
const s97tLq = {
...
const scHVdW = {
  context: "button",
  string: "Associar produto"
};
const Q8wHwJ = {
  string: "Cole\xE7\xE3o deletada"
};
const MxhVZv = {
  string: "Tem a certeza que pretende apagar  a imagem da cole\xE7\xE3o?"
};
const I1Mz7h = {
...
const MPOj0I = {
  ...
  string: "Guardar altera\xE7\xF5es"
};
const FWWliu = {
...
const hMRP6J = {
  string: "Endere\xE7o de envio principal"
};
const VyzsWZ = {
  string: "Endere\xE7o de fatura\xE7\xE3o principal"
};
const nLML8Y = {
  string: "Endere\xE7o de envio principal"
};
...
const hLOEeb = {
  context: "button",
  string: "Definir como endere\xE7o de cobran\xE7a padr\xE3o"
};
const BfJGij = {
  context: "header",
...
const biVFKU = {
  context: "subsection header",
  string: "Morada para Cobran\xE7a"
};
const jGGnSZ = {
  context: "page header",
...
const IoCMjg = {
  ...
  string: "Nenhuma cole\xE7\xE3o encontrada"
};
const ht9yOD = {
  context: "table head",
  string: "Nome da Cole\xE7\xE3o"
...
const U2mOqA = {
  string: "N\xE3o foi enconytrado vouchers"
};
const GVinbz = {
  context: "column title",
  string: "Valor"
...
const GLX9II = {
  ...
  string: "Mesmo que o endere\xE7o de entrega"
};
const Qovenh = {
...
const uUsZ7m = {
  context: "order payment",
  string: "Quantidade pr\xE9-autorizada"
};
const HaQ8cg = {
  context: "button",
  string: "Restitui\xE7\xE3o"
};
const uzAPCt = {
...
const GZgjK7 = {
  context: "page",
  string: "vai ser vis\xEDvel a partir de {date}"
};
const X26jCC = {
  context: "page label",
  string: "Vis\xEDvel"
...
const XMrYaA = {
  context: "checkbox label",
  string: "Usu\xE1rio est\xE1 ativo"
};
const YJ4TXc = {
  context: "tab name",
...
const IFWHn0 = {
  context: "error message",
  string: "N\xE3o se encontra definida a morada de fatura\xE7\xE3o"
};
const ij7olm = {
  context: "error message",
...
const Xb6BJ9 = {
  context: "error message",
  string: "Pagamento manual n\xE3o pode ser devolvido"
};
const WzA5Ll = {
...
const gKdGxP = {
  context: "error message",
  string: "Apenas pagamentos pr\xE9-autorizados podem ser recebidos"
};
const V2BBQu = {
...
const VEE4gD = {
  context: "error message",
  string: "M\xE9todo de envio n\xE3o \xE9 v\xE1lido para o endere\xE7o de entrega escolhido."
};
const ychKsb = {
  context: "error message",
...
const pt = {
  ...
  zxs6G3,
  "5BajZK": {
    string: "Veja e edite as op\xE7\xF5es do site"
  },
  RQUkVW,
  EIULpW,
  "5RmuD+": {
    string: "Defina a informa\xE7\xE3o de armaz\xE9m"
  },
  m19JfL,
  yJynYK,
  ojHyj3,
  ...
  Urh2N3,
  "28GZnc": {
    string: "Escreva para come\xE7ar a procura..."
  },
  "0Vyr8h": {
  ...
  bj1U23,
  "svK+kv": {
    string: "{counter,plural,one {Tem a certeza que quer eliminar este menu?} other {Tem a certeza que quer eliminar {displayQuantity} menus?}}"
  },
  "1LBYpE": {
    context: "dialog header",
    string: "Eliminar Menus"
  },
  "OwG/0z": {
    string: "Menu eliminado"
  },
  "0nL1D6": {
  ...
  "7Chrsf": {
    string: "As senhas nao correspondem"
  },
  WhKGPA,
  lm9NSK,
  "Yy/yDL": {
  ...
  "2oyWT9": {
    context: "button",
    string: "Voltar \xE0 p\xE1gina de autentica\xE7\xE3o."
  },
  "2ob30/": {
    string: "Sucesso! Dentro de minutos ir\xE1 receber uma mensagem com instruc\xE7\xF5es de como redefinir a sua senha."
  },
  C0JLNW,
  hOxIeP,
  "0OfZJA": {
  ...
  vEYtiq,
  "8HRy+U": {
    string: "Descri\xE7\xE3o da Categoria"
  },
  vof5TR,
  JiXNEV,
  vy7fjd,
  ...
  Irflxf,
  "7l5Bh9": {
    string: "{counter,plural,one {Tem a certeza que pretende apagar este produto?} other {Tem a certeza que pretende apagar {displayQuantity} produtos?}}"
  },
  xl7Fag,
  "Pp/7T7": {
    string: "{counter,plural,one {Tem a certeza que pretende apagar esta categoria?} other {Tem a certeza que pretende apagar {displayQuantity} categorias?}}"
  },
  HvJPcU,
  KCjd1o,
  "3DGvA/": {
  ...
  "e+L+q3": {
    string: "Lembre-se que isto tamb\xE9m vai apagar todos os produtos associados a esta categoria."
  },
  sG0w22,
  xRkj2h,
  KeO51o,
  ...
  Q8wHwJ,
  "56vUeQ": {
    string: "Produto adicionado \xE0 cole\xE7\xE3o"
  },
  MxhVZv,
  "AulH/n": {
    string: "{counter,plural,one {Are you sure you want to unassign this product?} other {Are you sure you want to unassign {displayQuantity} products?}}"
  ...
  LmKz3g,
  "/X8Mjx": {
    string: "Testar com <emphasis>GraphQL API</emphasis>"
  },
  xwEc8K,
  "4gZl/n": {
  ...
  ChAjJu,
  "s/sTT6": {
    string: "Se vazio, a pr\xE9-visualiza\xE7\xE3o ser\xE1 auto-gerada."
  },
  "450Fty": {
    string: "None"
  },
  ...
  "+7OsyM": {
    context: "button",
    string: "Definir como endere\xE7o de entrega padr\xE3o"
  },
  BfJGij,
  Zd3Eew,
  bHdFph,
  ...
  "/oyr6M": {
    context: "no variants",
    string: "Nenhuma varia\xE7\xE3o encontrada."
  },
  Q1HhPk,
  lHccsy,
  "2E1xZ0": {
  ...
  "45zP+r": {
    context: "voucher discount",
    string: "Produtos espec\xEDficos"
  },
  WasHjQ,
  n7Fg8i,
  "ESDTC/": {
  ...
  "9gb9b4": {
    context: "address type",
    string: "Adicione uma nova morada"
  },
  Qph0GE,
  xWEFrR,
  "kQq6/o": {
  ...
  G3ay2p,
  "yT/GAp": {
    string: "C\xF3digo de rastreamento"
  },
  "/BJQIq": {
    context: "dialog header",
  ...
  "3C3Nj5": {
    context: "button",
    string: "Adicionar varia\xE7\xE3o"
  },
  gF7hbK,
  EsZH44,
  rJ3lkW,
  ...
  "4EuJKs": {
    string: "Todos os pre\xE7os dos produtos s\xE3o inclusos com os impostos"
  },
  "98isC5": {
    string: "Mostrar pre\xE7o bruto a clientes na loja"
  },
  FNKhkx,
  "+OV+Gj": {
    context: "button",
...
//# sourceMappingURL=pt.b678886b.js.map
